...
# ============================================================================
# This script demonstrates how to filter and visualize data from multiple
# patient groups (e.g., different timepoints, severity levels, treatments)
# ============================================================================
...
# (Use the main visualization code from cytokine_pie_chart.R)
...
#   ggsave(
#     filename = paste0(groups[[i]]$name, "_cytokine_chart.png"),
#     plot = plots[[i]],
#     width = 10,
#     height = 8,
#     dpi = 300
